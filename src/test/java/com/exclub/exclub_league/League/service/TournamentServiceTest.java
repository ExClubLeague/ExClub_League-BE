...
//        Long matchId = 7L; // 기존에 존재하는 매칭 ID 사용
...
//
//        // 첫 번째 매칭 검증 (Team 2 vs Team 4)
//        TournamentMatch match1 = secondRoundMatches.get(0);
//        assertEquals("Team 2", match1.getTeam1().getName());
//        assertEquals("Team 4", match1.getTeam2().getName());
//        assertEquals(2, match1.getRoundNumber());
//        assertEquals("PENDING", match1.getMatchStatus());
//
//        // 두 번째 매칭 검증 (Team 7 vs Team 8)
//        TournamentMatch match2 = secondRoundMatches.get(1);
//        assertEquals("Team 7", match2.getTeam1().getName());
//        assertEquals("Team 8", match2.getTeam2().getName());
//        assertEquals(2, match2.getRoundNumber());
//        assertEquals("PENDING", match2.getMatchStatus());
//
//        // 부전승 처리 검증 (Team 10)
//        TournamentMatch byeMatch = secondRoundMatches.get(2);
//        assertEquals("Team 10", byeMatch.getTeam1().getName());
//        assertNull(byeMatch.getTeam2(), "부전승일 때 상대 팀은 없어야 함");
//        assertEquals(2, byeMatch.getRoundNumber());
//        assertEquals("BYE", byeMatch.getMatchStatus());
//        assertEquals("Team 10", byeMatch.getWinnerTeam().getName());
//
//        // 매칭 저장 여부 검증
//        verify(matchRepository, times(3)).save(any(TournamentMatch.class));
//    }
//
//
//    @Test
...
//
//        // 첫 번째 매칭 검증 (Team 2 vs Team 4)
//        TournamentMatch match1 = thirdRoundMatches.get(0);
//        assertEquals("Team 2", match1.getTeam1().getName());
//        assertEquals("Team 4", match1.getTeam2().getName());
//        assertEquals(roundNumber, match1.getRoundNumber());
//        assertEquals("PENDING", match1.getMatchStatus());
//
//        // 부전승 처리 검증 (Team 8)
//        TournamentMatch byeMatch = thirdRoundMatches.get(1);
//        assertEquals("Team 8", byeMatch.getTeam1().getName());
//        assertNull(byeMatch.getTeam2(), "부전승일 때 상대 팀은 없어야 함");
//        assertEquals(roundNumber, byeMatch.getRoundNumber());
//        assertEquals("BYE", byeMatch.getMatchStatus());
//        assertEquals("Team 8", byeMatch.getWinnerTeam().getName());
//
//        // 매칭 저장 여부 검증
//        verify(matchRepository, times(2)).save(any(TournamentMatch.class));
//    }
//}
//
